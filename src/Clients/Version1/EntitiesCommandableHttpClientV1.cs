...
{
    public class EntitiesCommandableHttpClientV1 : CommandableHttpClient, IEntitiesClientV1
    {
        public EntitiesCommandableHttpClientV1(object config = null) : base("v1/entities")
        {
            if (config != null)
